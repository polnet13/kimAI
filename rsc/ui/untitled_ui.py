...
"    }")
        ...
        self.btn_player = QPushButton(self.topMenu)
        self.btn_player.setObjectName(u"btn_player")
        sizePolicy3 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.btn_player.sizePolicy().hasHeightForWidth())
        self.btn_player.setSizePolicy(sizePolicy3)
        self.btn_player.setMinimumSize(QSize(0, 45))
        font1 = QFont()
        font1.setFamilies([u"Segoe UI"])
        font1.setBold(False)
        font1.setItalic(False)
        self.btn_player.setFont(font1)
        self.btn_player.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.btn_player.setLayoutDirection(Qt.LeftToRight)
        self.btn_player.setStyleSheet(u"")

        self.verticalLayout_8.addWidget(self.btn_player)
...
"    }")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_player.setText(QCoreApplication.translate("MainWindow", u"\ud50c\ub808\uc774\uc5b4", None))
